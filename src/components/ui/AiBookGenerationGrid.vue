<template>
    <v-container>
        ...
        <div class="panel">
            ...
            <ProcessedResult @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></ProcessedResult>
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">AiBookGeneration 등록</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
                    ...
                    <v-card-text>
                        <AiBookGeneration :offline="offline"
                            :isNew="!value.idx"
                            :editMode="true"
                            :inList="false"
                            v-model="newValue"
            ...
            >
                <v-card>
                    <v-toolbar
                        ...
                        height="50px"
                    >
                        <div style="color:white; font-size:17px; font-weight:700;">AiBookGeneration 수정</div>
                        <v-spacer></v-spacer>
                        <v-icon
                            color="white"
                            small
